...
if ($campaign_id) {
    ...
    $result = mysql_query($SQL_campname, $Conn) or die("ไม่สามารถเรียกดูข้อมูลcampaignได้");
    ...
    $resultListName = mysql_query($SQL_listname, $Conn) or die("ไม่สามารถเรียกดูcampaign2ข้อมูลได้");
    while ($row = mysql_fetch_array($resultListName)) {
...
if ($group_id) {
    ...
    $result = mysql_query($SQL_groupname, $Conn) or die("ไม่สามารถเรียกดูข้อมูลgroupได้");
    while ($row = mysql_fetch_array($result)) {
...
if ($team_id) {
    ...
    $result = mysql_query($SQL_teamname, $Conn) or die("ไม่สามารถเรียกดูข้อมูลteamได้");
    while ($row = mysql_fetch_array($result)) {
...
";
$result = mysql_query($SQL, $Conn) or die("ไม่สามารถเรียกดูข้อมูล main queryได้" . $team_id . $group_id);
...
$result_app =  mysql_query($sql_app,  $Conn) or die("ไม่สามารถเรียกดูข้อมูล app ได้");
