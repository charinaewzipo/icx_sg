...
from t_aig_app where campaign_id = '$campaign_id' and AppStatus = 'Approve' and flag=$flag" ;
...
$Row_Count = $benefi_no_count+$insured_no_count+$Policy_Holder_Count+$Policy_Cert_Count+$Payment_Details_Count+$Policy_Cert_Rider+$Policy_Cert_Premium;
 ...
 $SQL = "select app.*,agent.agent_login from `t_aig_app` app left join `t_agents` agent on app.agent_id=agent.agent_id where app.campaign_id = '$campaign_id' and app.AppStatus = 'Approve' and flag=$flag" ;
