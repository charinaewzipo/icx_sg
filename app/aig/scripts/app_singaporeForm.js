document.addEventListener("DOMContentLoaded", () => {
          ...
          if (coverId) {
            ...
            if (coverDetails) {
              ...
              if (planCoverLimitAmount) {
                ...
                console.warn("planCoverLimitAmount element not found in the row.");
              }
  ...
  const manualSetDefaultValueForm = () => {
    ...
    document.querySelector('select[name="Ncd_Level"]').value =
    ncdInfo.ncdLevel;
  ...
  const manualSetDefaultValueFormInsuredList = () => {
    ...
    document.querySelector('input[name="insured_auto_vehicle_vehicleUsage"]').value =
    vehicleInfo.vehicleUsage;
    document.querySelector(
