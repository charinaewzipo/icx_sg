      ...
      <form id="application">
          ...
          <fieldset id="form-content">
            ...
            <table id="table-form">
              ...
              <tr>
                ...
                <td <?php if($campaign_test_code!='SMK'){ echo $hide;} ?>>
                <?php
                  if ($row["smoke"] == '1') {
                    $CHK_SMOKE = 'checked';
                  }
          ...
          <fieldset id="form-content">
            ...
            <table id="table-form">
              ...
              <tr>
                ...
                <td><input type="text" name="INSTALMENT_PREMIUM" id="INSTALMENT_PREMIUM" maxlength="15"
                    value="<?php echo $row["INSTALMENT_PREMIUM"]; ?>" readonly /> บาท&nbsp;
                  ยอดที่ใช้ตัด Payment : <input type="text" name="INSTALMENT_COPY" id="INSTALMENT_COPY" maxlength="15" value="" readonly
                     /> บาท
                </td>
              </tr>
            </table><br />
            ...
            <!--Insure 2-->
            <div <?php if($max_insured<2){ echo $hide;} ?>>
            <div>
            ...
            <table id="table-form">
              ...
              <tr>
                ...
                <!--Insure 3-->
            <div <?php if($max_insured<3){ echo $hide;} ?>>
                  ...
                  <tr>
                    <td>คำนำหน้า : </td>
                          ...
                          <tr>
                            ...
                            <input type="text" name="INSURED_DOB3_V" maxlength="10"
                              value="<?php echo $IN3_xxx_DOB; ?>" />
                          </td>                               
                            <th>&nbsp;</th>
                            <td>ความสัมพันธ์ : </td>
            ...
            <!--Insure 4-->
            <div <?php if($max_insured<4){ echo $hide;} ?>>
            <div><h2>ผู้เอาประกันที่ 4</h2></div>
              <table id="table-form">
                  ...
                  <input type="text" name="INSURED_DOB4_V" maxlength="10"
                    value="<?php echo $IN4_xxx_DOB; ?>" />
                </td>                             
                            <th>&nbsp;</th>
                            <td>ความสัมพันธ์ : </td>
            ...
            <!--Insure 5-->
            <div <?php if($max_insured<5){ echo $hide;} ?>>
            <div><h2>ผู้เอาประกันที่ 5</h2></div>
              <table id="table-form">
                  ...
                  <input type="text" name="INSURED_DOB5_V" maxlength="10"
                    value="<?php echo $IN5_xxx_DOB; ?>" />
                </td>                               
                            <th>&nbsp;</th>
                            <td>ความสัมพันธ์ : </td>
        ...
        <div>
          <fieldset id="form-content">
            ...
            <div <?php if($max_beneficiary<1){ echo $hide;} ?>>
            <div>
            ...
            <table id="table-form">
              ...
              <tr>
                ...
                <td><input type="number" name="BENEFICIARY_BENEFIT1" maxlength="3" size="8"
            ...
            <div <?php if($max_beneficiary<2){ echo $hide;} ?>>
            <div>
            ...
            <table id="table-form">
              ...
              <tr>
                ...
                <th>&nbsp;</th>
                <td>ร้อยละของผลประโยชน์ : </td>
                <td><input type="number" name="BENEFICIARY_BENEFIT2" maxlength="3" size="8"
            ...
            <div <?php if($max_beneficiary<3){ echo $hide;} ?>>
            <div>
            ...
            <table id="table-form">
              ...
              <tr>
                ...
                <th>&nbsp;</th>
                <td>ร้อยละของผลประโยชน์ : </td>
                <td><input type="number" name="BENEFICIARY_BENEFIT3" maxlength="3" size="8"
            ...
            <div <?php if($max_beneficiary<4){ echo $hide;} ?>>
            <div>
            ...
            <table id="table-form">
              ...
              <tr>
                <td>ชื่อ : </td>
                <td><input type="text" name="BENEFICIARY_NAME4" maxlength="60" size="35"
                    value="<?php echo $row["BENEFICIARY_NAME4"]; ?>" /></td>
                <th>&nbsp;</th>
                <td>นามสกุล : </td>
                <td><input type="text" name="BENEFICIARY_LASTNAME4" maxlength="60" size="35"
                    value="<?php echo $row["BENEFICIARY_LASTNAME4"]; ?>" /></td>
              </tr>
              <tr>
                <td>ความสัมพันธ์ : </td>
                ...
                <th>&nbsp;</th>
                <td>ร้อยละของผลประโยชน์ : </td>
                <td><input type="number" name="BENEFICIARY_BENEFIT4" maxlength="3" size="8"
                    value="<?php echo $row["BENEFICIARY_BENEFIT4"]; ?>" /></td>
              </tr>
              <tr>
                <td>เพศ : </td>
            ...
            <fieldset id="form-content">
              ...
              <div class="table">
                ...
                <div class="table-content">
                  <div class="table-row" <?php if($url_billing_payment ==''){ echo $hide;} ?>>
                    <div class="table-data">Change card number and generate billing</div>
                    <div class="table-data"><button type="button" class="button" id="btnPaymentBilling"
                        onclick="window.open('<?php echo $url_billing_payment; ?>')">Payment</button>
                    </div>
                  </div>
                  <div class="table-row" <?php if($url_online_payment ==''){ echo $hide;} ?>>
                    <div class="table-data">Online Payment Gateway </div>
                    <div class="table-data"><button type="button" class="button" id="btnPaymentOnline"
                        onclick="window.open('<?php echo $url_online_payment; ?>')">Payment</button>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div>
          <fieldset id="form-content">
            Note TSR :
            <textarea rows="5" name="REMARK" id="REMARK" cols="100"><?php echo $row["REMARK"]; ?></textarea>
          </fieldset>
        </div>
