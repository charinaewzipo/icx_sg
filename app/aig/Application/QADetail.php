...
<body>
    ...
    $strSQL1 = "SELECT * FROM t_aig_qa_answer WHERE app_id = '$app_id' and col_id=1 ";
    ...
    {		
        ...
        $strSQL3 = "SELECT app.*,COALESCE(CONCAT(campaign.plancode,ProposalNumber),ProposalNumber) as quotation FROM t_aig_app app LEFT OUTER JOIN  t_campaign campaign ON app.campaign_id = campaign.campaign_id  WHERE id = '$app_id' ";
...
while($objResuut = mysqli_fetch_array($objQuery))
{
    ...
    $answer_qa_true = '';
    $answer_qa_fault = '';
    $strSQL_answer = "SELECT answer$count as answer, col_id, create_by FROM t_aig_qa_answer where  app_id = '$app_id' and col_id in(1,2)";
    //echo $strSQL_answer ;
