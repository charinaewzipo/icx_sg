        ...
        <fieldset id="form-content">
          ...
          <table id="table-form">
            ...
            <tr>
              ...
              <td><input type="text" name="ADDRESSNO1" size="30" /></td>
              <th>&nbsp;</th>
              <td>หมู่บ้าน/อาคาร : </td>
              <td><input type="text" name="BUILDING1" size="30" /></td>
            </tr>
            <tr>
              <td>หมู่ : </td>
              <td><input type="text" name="MOO1" size="10" /></td>
              <th>&nbsp;</th>
              <td>ตรอก/ซอย : </td>
              <td><input type="text" name="SOI1" size="30" /></td>
            </tr>
            <tr>
              <td>ถนน : </td>
              <td><input type="text" name="ROAD1" size="30" /></td>
              <th>&nbsp;</th>
            ...
            <tr>
              ...
              <td><input type="text" name="MOBILE1" value="<?php echo $Mobile1; ?>" size="15" required />
              </td>
            </tr>
        ...
        <fieldset id="form-content">
          ...
          <table id="table-form">
            ...
            <tr>
              ...
              <td>
                <input type="text" name="INSTALMENT_PREMIUM" maxlength="15" value="" readonly /> บาท&nbsp;
          ...
          <div class="table">
            ...
            <div class="table-content">
              <div class="table-row">
                ...
                <div class="table-data"><button type="button" class="button payment"
