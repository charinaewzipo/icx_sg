...
<body>
  ...
  while ($objResult3 = mysqli_fetch_array($result3)) {
    ...
    $PRODUCT_NAME = $objResult3["campaign_name"];
  ...
  <div id="content">
    ...
    <form name="App" method="post" action="newQA_non_sale_save.php">
      ...
      $end_tab = "";
      $check_section = 0;
      $strSQL = "SELECT * FROM t_aig_qa_form where section in( 1,2,3) and form_id = '2' ORDER BY section,sequence ASC";
      ...
      ?>
          ...
          <script>
            console.log(document.getElementById('qc_score_value').value)
          </script>
