...
<!--				   <th>&nbsp;</th>
        ...
        <legend>แบบประกันภัย</legend>
        	<table id="table-form">
                <tr>
				  <td>แผนประกันภัย  : </td>
                  <td><select name="COVERAGE_NAME" required onchange="getPremiumGenEx()">
                     ...
                     <option value="3000000.00">3000000.00</option>
							  ...
							  <td>การชำระเงิน  : </td>
			                  <td><select name="PaymentFrequency" required onchange="getPremiumGenEx()">
...
?>
            <div id="answer">
                ...
                <p>2.  ท่านเคยถูกปฏิเสธการขอเอาประกันภัยอุบัติเหตุส่วนบุคคล หรือการขอเอาประกันชีวิต หรือถูกปฏิเสธการต่ออายุสัญญาประกันภัย หรือถูกเรียก เก็บเบี้ยประกันภัยเพิ่มสำหรับการประกันภัยดังกล่าวหรือไม่ ?<br /><br /><input type="radio" name="Answer2_1" value="0" <?php echo $chk_Answer2_1;?> required/> ไม่เคย &nbsp;&nbsp;&nbsp;<input type="radio" name="Answer2_1" value="1" <?php echo $chk_Answer2_2;?> /> เคย</p>
           		<p>(ถ้าเคยโปรดระบุรายละเอียด) บริษัท <input type="text" name="Answer2_2"   size="30" value="<?php echo $row["Answer2_2"];?>" /> สาเหตุ <input type="text" name="Answer2_3"   size="30" value="<?php echo $row["Answer2_3"];?>" /> เมื่อใด <input type="text" name="Answer2_4"   size="20" value="<?php echo $row["Answer2_4"];?>" /></p>
            	<br />
                <p>3. ท่านมีอวัยวะส่วนใดผิดปรกติ หรือพิการบ้าง หรือไม่ ?<br /><br /><input type="radio" name="Answer3_1" value="0" <?php echo $chk_Answer3_1;?> required/> ไม่มี &nbsp;&nbsp;&nbsp;<input type="radio" name="Answer3_1" value="1" <?php echo $chk_Answer3_2;?>/> มี</p>
           		<p>(ถ้ามี)  โปรดแจ้ง <input type="text" name="Answer3_2"   size="100" value="<?php echo $row["Answer3_2"];?>" /> 
            	<br />
                
                <br />
                <p>ผู้ประกันภับประสงค์จะใช้สิทธิ์ขอยกเว้นภาษีเงินได้ตามกฎหมายว่าด้วยภาษีอากร หรือไม่ ?<br /><br /><input type="radio" name="Answer4_1" value="0" <?php echo $chk_Answer3_1;?> required/> ไม่มีความประสงค์ &nbsp;&nbsp;&nbsp;<input type="radio" name="Answer4_1" value="1" <?php echo $chk_Answer3_2;?>/> มีความประสงค์</p>
           		<p>(ถ้ามี)  โปรดแจ้งเลขประจำตัวผู้เสียภาษี <input type="text" name="Answer4_2"   size="100" value="<?php echo $row["Answer3_2"];?>" /> 
            	<br />
...
?>
 ...
 <?php } ?>
                  ...
                  <td>&nbsp;&nbsp;<a  href="appRegalPA.php?Id=<?php echo $Id;?>" target="_blank"/>บทยืนยัน</a></td>
               </tr>
            </table>
          </fieldset>
  </div>
