...
$Answer6_1 = $_POST["Answer6_1"];
$Answer6_2 = $_POST["Answer6_2"];

$Approved_code = $_POST["Approved_code"];

if($AppStatus =='Success'){
	
	 $Approved_Time = $currenttime_app;
}else{
	$Approved_Time = '';
}
...
$SQL_history = "INSERT INTO t_app_history ( ProposalNumber, status, remark, update_by, update_date, update_time )
								VALUES('$Id', '$AppStatus' , '$remark' , '$agent_id' , '$currentdate_app' , '$currenttime_app' )" ;
								mysql_query($SQL_history,$Conn) ;

 /*Insert YersFile*/
$SQL_YesFile = "update t_app  set
Title = '$Title',
Firstname = '$Firstname',
Lastname = '$Lastname',
...
card_name_th = '$card_name_th',
card_lastname_th = '$card_lastname_th',
card_name_eng = '$card_name_eng',
card_lastname_eng = '$card_lastname_eng',
CardType = '$CardType',
...
PolicyEffectiveDate = '$completed_date',
ProductCode = '$ProductCode',

Answer6_1 = '$Answer6_1',
Answer6_2 = '$Answer6_2',

BENEFICIARY_AGE1 = '$BENEFICIARY_AGE1',
BENEFICIARY_AGE2 = '$BENEFICIARY_AGE2',
BENEFICIARY_AGE3 = '$BENEFICIARY_AGE3',
BENEFICIARY_AGE4 = '$BENEFICIARY_AGE4',

IdCard_from_distric = '$IdCard_from_distric',
IdCard_from_province = '$IdCard_from_province',
...
payment_bod = '$payment_bod',
payment_age = '$payment_age',
payment_idcard = '$payment_idcard',
payment_phone = '$payment_phone',
payment_occupation = '$payment_occupation',
payment_postion = '$payment_postion',
payment_tax = '$payment_tax',
payment_title = '$payment_title',

Payer_Sex = '$Payer_Sex',
Payer_status = '$Payer_status',
AddressNo4 = '$AddressNo4',
building4 = '$building4',
Moo4 = '$Moo4',
Soi4 = '$Soi4',
Road4 = '$Road4',
Sub_district4 = '$Sub_district4',
district4 = '$district4',
province4 = '$province4',
zipcode4 = '$zipcode4',
...
if(mysql_query($SQL_YesFile,$Conn))
{
	if($camp == 'GenExclusive'){
		echo "<script>alert('Save Complete.');window.location='appDetail.php?Id=$Id';</script>";
	}elseif($camp == 'GenExclusivePlus'){
		echo "<script>alert('Save Complete.');window.location='appDetail_exp.php?Id=$Id';</script>";
	}elseif($camp == 'GenHealth'){
		echo "<script>alert('Save Complete.');window.location='appDetail_Health.php?Id=$Id';</script>";
	}
