...
?>
            <div id="answer">
            	...
            	<br />
                <p>3. ท่านเคยได้รับการวินิจฉัย หรือเคยเข้ารับการรักษาพยาบาลด้วยโรค การผ่าตัด การได้รับการบาดเจ็บทางร่างกาย หรือไม่ ?<br /><br /><input type="radio" name="Answer3_1" value="0" <?php echo $chk_Answer3_1;?> required/> ไม่เคย &nbsp;&nbsp;&nbsp;<input type="radio" name="Answer3_1" value="1" <?php echo $chk_Answer3_2;?>/> เคย</p>
           		<p>(ถ้าเคยโปรดระบุรายละเอียด) ชื่อโรค/ลักษณะการบาดเจ็บ /สาเหตุ <input type="text" name="Answer3_2"   size="100" value="<?php echo $row["Answer3_2"];?>" /> 
            	<br />
