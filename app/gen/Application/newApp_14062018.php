...
<!--				   <th>&nbsp;</th>
        ...
        <div style="text-align:center;">
			<img src="images/plan_table.jpg"  width="800"/>
        </div>
  ...
  <!--end  form 5-->
        ...
        <legend>คำถามสุขภาพ</legend>
            ...
            <div id="answer">
            	...
            	<br />
                <p>3. ท่านมีอวัยวะส่วนใดผิดปรกติ หรือพิการบ้าง หรือไม่ ?<br /><br /><input type="radio" name="Answer3_1" value="0" required/> ไม่มี &nbsp;&nbsp;&nbsp;<input type="radio" name="Answer3_1" value="1" /> มี</p>
           		<p>(ถ้ามี)  โปรดแจ้ง <input type="text" name="Answer3_2"   size="100" /> 
            	<br />
                
                <br />
                <p>ผู้ประกันภับประสงค์จะใช้สิทธิ์ขอยกเว้นภาษีเงินได้ตามกฎหมายว่าด้วยภาษีอากร หรือไม่ ?<br /><br /><input type="radio" name="Answer4_1" value="0" <?php echo $chk_Answer3_1;?> required/> ไม่มีความประสงค์ &nbsp;&nbsp;&nbsp;<input type="radio" name="Answer4_1" value="1"/> มีความประสงค์</p>
           		<p>(ถ้ามี)  โปรดแจ้งเลขประจำตัวผู้เสียภาษี <input type="text" name="Answer4_2"   size="100"  /> 
            	<br />
