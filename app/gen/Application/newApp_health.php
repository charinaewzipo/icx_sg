        ...
        <fieldset id="form-content">
			...
			<tr>
              ...
              <tr>
                  ...
                  <td><input type="text" name="payment_name" maxlength="60" size="35" value="" /></td>
                  <td>&nbsp;</td>
                  <td>นาสกุล ผู้ชำระเบี้ย : </td>
                  <td><input type="text" name="payment_lastname" maxlength="60" size="35" value="" /></td>
              </tr>
              <tr>
				  <td>วันเดือนปี เกิด : </td>
                  <td><input type="text" name="payment_bod" maxlength="30" size="30" value="" /></td>
                  <td>&nbsp;</td>
                  <td>อายุ : </td>
                  <td><input type="text" name="payment_age" maxlength="30" size="10" value="" /> ปี</td>
              </tr>
              <tr>
				  <td>เลขที่บัตรประชาชน : </td>
                  <td><input type="text" name="payment_idcard" maxlength="30" size="30" value="" /></td>
                  <td>&nbsp;</td>
                  <td>เบอร์โทรศัพท์ : </td>
                  <td><input type="text" name="payment_phone" maxlength="30" size="15" value="" /></td>
              </tr>
              <tr>
				  <td>เพศ : </td>
              ...
              <tr>
                   <td>เลขที่ : </td>
                   <td><input type="text" name="AddressNo4" maxlength="20" /></td>
                   <th>&nbsp;</th>
                   <td>หมู่บ้าน/อาคาร : </td>
                   <td><input type="text" name="building4" maxlength="50"  size="30"/></td>
              </tr>
              <tr>
              	   <td>หมู่ : </td>
                   <td><input type="text" name="Moo4" maxlength="50"  size="10"/></td>
                   <th>&nbsp;</th>
                   <td>ตรอก/ซอย : </td>
                   <td><input type="text" name="Soi4" maxlength="50"  size="30"/></td>
              </tr>
			  <tr>
              		<td>ถนน : </td>
                   <td><input type="text" name="Road4" maxlength="50"  size="30"/></td>
                   <th>&nbsp;</th>
              	   <td>แขวง/ตำบล : </td>
                   <td><input type="text" name="Sub_district4" maxlength="50"  size="30"/></td>
              </tr>
              <tr>
              	   <td>เขต/อำเภอ : </td>
                   <td><input type="text" name="district4" maxlength="50"  size="30"/></td>
                   <th>&nbsp;</th>
                   <td>จังหวัด : </td>
                   <td>
               ...
               <tr>
              	   <td>รหัสไปรษณีย์ : </td>
                 <td><input type="text" name="zipcode4" maxlength="5" size="10" /></td>
                 <th>&nbsp;</th>
              	   <td>อีเมล์ : </td>
                   <td><input type="text" name="Payer_email" maxlength="100"  size="30"/></td>
               </tr>
              ...
              <tr>
                  ...
                  <td>&nbsp;</td>
                  <td>ตำแหน่ง : </td>
                  <td><input type="text" name="payment_postion" maxlength="30" size="30" value="" /></td>
              </tr>
              <tr>
        ...
        <legend>คำถามสุขภาพ</legend>
            ...
            <div id="answer">
                ...
                <p>2.  ท่านเคยถูกปฏิเสธการขอเอาประกันภัยอุบัติเหตุส่วนบุคคล หรือการขอเอาประกันชีวิต หรือถูกปฏิเสธการต่ออายุสัญญาประกันภัย หรือถูกเรียก เก็บเบี้ยประกันภัยเพิ่มสำหรับการประกันภัยดังกล่าวหรือไม่ ?<br /><br /><input type="radio" name="Answer2_1" value="0" required/> ไม่เคย &nbsp;&nbsp;&nbsp;<input type="radio" name="Answer2_1" value="1" /> เคย</p>
           		<p>(ถ้าเคยโปรดระบุรายละเอียด)  <input type="text" name="Answer2_2"   size="100" />
            	<br /><br />
...
โรคทางสมองและหลอดเลือดสมอง โรคทาง ระบบประสาท อัมพาต เนื้องอก โรคกระดูกหรือโรคกล้ามเนื้อ หรือโรคอื่นๆ<br /><br /><input type="radio" name="Answer3_1" value="0" required/> ไม่เคย &nbsp;&nbsp;&nbsp;<input type="radio" name="Answer3_1" value="1" /> เคย</p>
           		<p>(ถ้าเคยโปรดระบุรายละเอียด)  <input type="text" name="Answer3_2"   size="100" /> 
            	<br /><br />
...
เข้ารับการปรึกษา การได้รับการสั่งยา รวมถึงชื่อยาที่ได้รับ หรือยาที่ปัจจุบันใช้อยู่<br /><br /><input type="radio" name="Answer4_1" value="0" required/> ไม่เคย &nbsp;&nbsp;&nbsp;<input type="radio" name="Answer4_1" value="1" /> เคย</p>
           		<p>(ถ้าเคยโปรดระบุรายละเอียด)  <input type="text" name="Answer4_2"   size="100" /> 
            	<br /><br />
...
ตรวจ วันเดือนปี และสถานที่ที่ตรวจ<br /><br /><input type="radio" name="Answer5_1" value="0" required/> ไม่เคย &nbsp;&nbsp;&nbsp;<input type="radio" name="Answer5_1" value="1" /> เคย</p>
           		<p>(ถ้าเคยโปรดระบุรายละเอียด)  <input type="text" name="Answer5_2"   size="100" /> 
            	<br /><br />
                <p>ผู้ประกันภับประสงค์จะใช้สิทธิ์ขอยกเว้นภาษีเงินได้ตามกฎหมายว่าด้วยภาษีอากร หรือไม่ ?<br /><br /><input type="radio" name="Answer6_1" value="0"  required/> ไม่มีความประสงค์ &nbsp;&nbsp;&nbsp;<input type="radio" name="Answer6_1" value="1" /> มีความประสงค์</p>
           		<p>(ถ้ามี)  โปรดแจ้งเลขประจำตัวผู้เสียภาษี <input type="text" name="Answer6_2"   size="100" value="" /> 
            	<br />
