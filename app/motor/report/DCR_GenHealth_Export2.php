...
$row = 0;
$r = 0;
$SQL = "select * from `t_app` where campaign_id = '1' and camp = 'GenHealth' and ( Approved_Date between '$startdate' and '$enddate') and AppStatus = 'Success' and CardType = 'เงินสด' " ;
...
$droot = "temp/";
$fname = "Gen Health Lump Sum_".$currentdate_DCR."_DCR.xls";
