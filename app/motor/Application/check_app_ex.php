...
echo "<script>window.location='appDetail_exp.php?Id=$Id';</script>";

}else{

  echo "<script>window.location='newApp_exp.php?campaign_id=$campaign_id&calllist_id=$calllist_id&agent_id=$agent_id&import_id=$import_id';</script>";
