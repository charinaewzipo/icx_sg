...
//echo  $SQL;
echo "<script>window.location='appDetail.php?Id=$Id';</script>";

}else{

  echo "<script>window.location='newApp.php?campaign_id=$campaign_id&calllist_id=$calllist_id&agent_id=$agent_id&import_id=$import_id';</script>";
