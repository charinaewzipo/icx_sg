        ...
        <legend>ผู้เอาประกัน</legend>
        	...
        	<table id="table-form">
              ...
              <tr>  
                  ...
                  <td><input type="text" name="insure_type" maxlength="13"  size="10" required00/></td>
                  <th>&nbsp;</th>
                  <td>รหัสรถ : </td>
                  <td><input type="text" name="car_type" maxlength="13"  size="10" required00/></td>
              </tr>		
...
<!--				   <th>&nbsp;</th>
        ...
        <legend>รายละเอียดการทำประกันภัย</legend>
        	<table id="table-form">
                <tr>
                  <td>บริษัทประกัน : </td>
                  <td><input type="text" name="insurer" maxlength="30" value="" required00/></td>
                  <th>&nbsp;</th>
                   <td>ประเภทความคุ้มครอง : </td>
               ...
               <tr>
                 ...
                 <tr>
                  ...
                  <td><input type="text" name="premium1" maxlength="15" value="" required00/> บาท</td>
                  <th>&nbsp;</th>
                  <td>ส่วนลดค่าเบี้ย : </td>
                  <td><input type="text" name="disc_premium1" maxlength="10" value=""  size="10" /> บาท</td>
                </tr>
                <tr>
                   <td>เบี้ยประกันภัยเรียกเก็บ : </td>
                  <td><input type="text" name="total_premium1" maxlength="15" value="" required00/> บาท</td>
                </tr>
                <tr>
                   <td>เบี้ย พรบ. : </td>
                  <td><input type="text" name="premium2" maxlength="15" value="" required00/> บาท</td>
                  <th>&nbsp;</th>
                   <td>ฟรี พรบ. : </td>
                 <td><input type="checkbox" name="free_premium2" /></td>
                </tr>
                <tr>
                   <td>ส่วนลด พรบ. : </td>
                  <td><input type="text" name="disc_premium2" maxlength="10" value="" size="10"/> บาท</td>
                  <th>&nbsp;</th>
                  <td>เบี้ย พรบ. เรียกเก็บ  : </td>
                  <td><input type="text" name="total_premium2" maxlength="15" value=""  size="10" /> บาท</td>
                </tr>
                <tr>
                   <td>พรบ. ออกให้โดย : </td>
                   <td><select name="insurer_prb" required00>
                        <option value=""><-- โปรดระบุ --></option>
                        <?php
        ...
        <legend>ข้อมูลการชำระเงิน</legend><br />
        	<table id="table-form">
                            ...
                            <td>ช่องทางการชำระ  : </td>
                  			<td><select id="payment_ch" name="payment_ch">
                            		<option><-- โปรดระบุ --></option>
                  					<option>บัตรเครติด</option>
									<option>เงินสด หรือโอน</option>
		  							</select> </td>
							</tr>
							<tr>
						 ...
						 <tr>
							 ...
							 <td><input id="AccountNo" type="text" name="AccountNo" maxlength="16"  size="30" value="" required00/></td>
                             <td>&nbsp;</td>
                              <td>วันที่บัตรหมดอายุ : </td>
                             <td><input id="card_expire" type="text" name="ExpiryDate" maxlength="16"  size="10" value="" required00/></td>
						</tr>
                <tr>
                	<td>ธนาคาร  : </td>
                 <td>
