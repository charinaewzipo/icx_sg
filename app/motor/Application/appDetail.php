			  ...
			  if (!HttPRequest) {
				...
				var pmeters = 'car_brand='+(document.getElementById('car_brand').value)+
							           '&car_model='+(document.getElementById('car_model').value)+
										...
										'&insure_type_s='+(document.getElementById('insure_type_s').value)+
										'&car_type_s='+(document.getElementById('car_type_s').value)+
...
<form id="App" name="App" method="post" action="xxxxx.php">
        ...
        <fieldset id="form-content" >
        	<table id="table-form">
                <tr>
				  <td>เลขที่รับแจ้ง : </td>
                   <td><input type="text" name="issue_no" maxlength="50" value="<?php echo $row["issue_no"]; ?>" /></td>
                   <td>&nbsp;</td>
                   <td>Application No : </td>
                   <td><input type="text" name="app_number" maxlength="50" value="<?php echo $row["app_number"]; ?>" readonly="readonly" /></td>
                   <td>Policy No : </td>
                   <td><input type="text" name="policy_no" maxlength="50" value="<?php echo $row["policy_no"]; ?>"  /></td>
                </tr>
            </table>
        </fieldset>
 		</div>
        ...
        <legend>ผู้เอาประกัน</legend>
	      ...
	      <tr>  
              ...
              <tr>  
                  ...
                  <td><input type="text" name="insure_type_s" id="insure_type_s" maxlength="13"  size="10" value="<?php echo $row["insure_type"]; ?>" required00/></td>
                  <th>&nbsp;</th>
                  <td>รหัสรถ : </td>
                  <td><input type="text" name="car_type_s" id="car_type_s" maxlength="13"  size="10" value="<?php echo $row["car_code"]; ?>" required00/></td>
              </tr>		
...
<!--				   <th>&nbsp;</th>
        ...
        <?php 
             ...
             if( $row["disc_premium1"]  == '' || $row["disc_premium1"]  == '0'  ){
				 $total_premium1 = $premium ;
             }else{
                 $total_premium1 = $premium - $row["disc_premium1"];
             }

             if( $row["disc_premium2"]  == '' || $row["disc_premium2"]  == '0'  ){
				 $total_premium2 = $premium_prb ;
             }else{
                 $total_premium2 = $premium_prb - $row["disc_premium2"];
             }
        
            $total_premium = $total_premium1 + $total_premium2;
        	...
        	<table id="table-form">
            	<tr>
                  ...
                  <td><select id="policy_type" name="policy_type" required>
                  					<option value="<?php echo $row["policy_type"] ; ?>"><?php echo $row["policy_type"] ; ?></option>
               ...
               <tr>
                   ...
                   <td><select name="insure_cover_type" required00>
										 	<option value="<?php echo $clame_type ; ?>"><?php echo $clame_type_name ; ?></option>
               ...
               <tr>
                 ...
                 <tr>
                  ...
                  <td><input type="text" name="premium1" id="premium1" maxlength="15" value="<?php echo $premium ; ?>" required00/> บาท</td>
                  <th>&nbsp;</th>
                  <td>ส่วนลดค่าเบี้ย : </td>
                  <td><input type="text" name="disc_premium1" id="disc_premium1" maxlength="10" value="<?php echo $row["disc_premium1"] ; ?>" onchange="premium1disc(this.value)"  size="10" /> บาท</td>
                </tr>
                <tr>
                   <td>เบี้ยประกันภัยเรียกเก็บ : </td>
                  <td><input type="text" name="total_premium1" id="total_premium1" maxlength="15" value="<?php echo $total_premium1 ; ?>" readonly="readonly" required00/> บาท</td>
                </tr>
                <tr>
                   <td>เบี้ย พรบ. : </td>
                  <td><input type="text" name="premium2" id="premium2" maxlength="15" value="<?php echo $premium_prb ; ?>" required00/> บาท</td>
                  <th>&nbsp;</th>
                  <?php
                ...
                <tr>
                   <td>ส่วนลด พรบ. : </td>
                  <td><input type="text" name="disc_premium2" id="disc_premium2" maxlength="10" value="<?php echo $row["disc_premium2"] ; ?>" onchange="premium2disc(this.value)" size="10"/> บาท</td>
                  <th>&nbsp;</th>
                  <td>เบี้ย พรบ. เรียกเก็บ  : </td>
                  <td><input type="text" name="total_premium2" id="total_premium2" maxlength="15" value="<?php echo $total_premium2 ; ?>"  size="10" /> บาท</td>
                </tr>
                <tr>
                   <td>เลขที่ พรบ. : </td>
                  <td><input type="text" name="policy_no2" id="policy_no2" maxlength="25" value="<?php echo $row["policy_no2"] ; ?>"/> </td>
                  <th>&nbsp;</th>
                  <td>พรบ. เริ่มคุ้มครอง  : </td>
                  <td><input type="text" id="datepicker4" name="policy_effective2" maxlength="15" value="<?php echo $row["policy_effective2"] ; ?>"  size="15" /> </td>
                </tr>
                <tr>
                   <td>พรบ. ออกให้โดย : </td>
                   <td><select name="insurer_premium2" required00>
                        <option value="<?php echo $row["insurer_premium2"] ; ?>"><?php echo $row["insurer_premium2"] ; ?></option>
                        <?php
        ...
        <legend>ข้อมูลการชำระเงิน</legend><br />
        	<table id="table-form">
              ...
              <tr>
							<td>เงื่อนไขการชำระ</td>
                			 <td><select name="pay_by_installments" id="pay_by_installments">
            ...
            <div id="result_Installmentsl"> 
              ...
              <table id="table_premium">
                ...
                <?php 
                $count = $count + 1 ;
                $payment_due = $payment_due + $objResuut["payment_due"];
                $installment = $installment + $objResuut["installment"];
            ...
            ยอดรวมที่ต้องชำระ : <b></b><?php echo $total_premium ;?></b> บาท
            </br>
            <?php 
            if($payment_due <> $total_premium){
               echo '<span style="color:red">ยอดนัดชำระ ไม่ตรงกับยอดรวมที่ต้องชำระ</span>' ;
            }
            ?>
            </br>
            </br>
...
?>
 ...
 <?php } ?>
                  ...
                  <td>ยอดเงินคืน : <input type="text" id="refund" name="refund" maxlength="10" size="10"  value="<?php echo $row["refund"]; ?>" /></td>
                   <td>วันที่ยกเลิก : <input type="text"  id="datepicker6"  name="refund_date" maxlength="10" size="10"  value="<?php echo $row["refund_date"]; ?>" /></td>
                  
               </tr>
               <tr >
               		<td style="padding-top: 30px;"><input name="Submit" type="button" value=" บันทึกข้อมูล " onClick="JavaScript:fncSubmit('page1')" /></td>
               </tr>
            </table>
          </fieldset>
  </div>
