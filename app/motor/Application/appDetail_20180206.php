        ...
        <legend>ผู้เอาประกัน</legend>
	      ...
	      <tr>  
              ...
              <tr>  
                  ...
                  <th>&nbsp;</th>
                  <td>รหัสรถ : </td>
                  <td><input type="text" name="car_type_s" id="car_type_s" maxlength="13"  size="10" value="" required00/></td>
              </tr>		
        	...
        	<table id="table-form">
               ...
               <tr>
                   ...
                   <td><select name="insure_cover_type" required00>
										 	<option value="<?php echo $clame_type ; ?>"><?php echo $clame_type ; ?></option>
...
?>
 ...
 <?php } ?>
                  ...
                  <td>ยอดเงินคืน : <input type="text" id="refund" name="refund" maxlength="10" size="10" /></td>
                  <th>&nbsp;</th>
