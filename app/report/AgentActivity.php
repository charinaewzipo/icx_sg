...
while($row = mysqli_fetch_array($result))
	...
	$SQL_count=  mysqli_query($Conn2, " SELECT sum(duration) FROM `cdr` WHERE (calldate BETWEEN '$strNewDate 00:00:00' and '$endNewDate 23:59:59') and src = '$ext' and disposition = 'ANSWERED' ");
	...
	if($totalTime_s <> '0'){
	$idletime_p = ($idle_time_s / $totalTime_s)*100;
