...
while($row = mysql_fetch_array($result))
    ...
    $SQL_count=  mysql_query(" SELECT COUNT(DISTINCT calllist_id) from t_call_trans where (create_date BETWEEN '$strNewDate 00:00:00' and '$endNewDate 23:59:59') and campaign_id = '$campaign_id' and agent_id = '$agent_id' and agent_id = '$agent_id' 
    and ( wrapup_id = '103||' or wrapup_id = '201||' or wrapup_id = '300||' or wrapup_id = '301||' or wrapup_id = '302||' or wrapup_id = '305||' or wrapup_id = '400||' or wrapup_id = '500||' or wrapup_id = '501||' or wrapup_id = '502||' ) ");
    $TotalLeadAttempted = mysql_result($SQL_count, 0);

    $SQL_count=  mysql_query(" SELECT COUNT(DISTINCT calllist_id) from t_call_trans where (create_date BETWEEN '$strNewDate 00:00:00' and '$endNewDate 23:59:59') and campaign_id = '$campaign_id' and agent_id = '$agent_id' and agent_id = '$agent_id' 
    and ( wrapup_id = '101||' or wrapup_id = '102||' or wrapup_id = '202||' or wrapup_id = '304||' ) ");
    $TotalLeadPossession = mysql_result($SQL_count, 0);
	
    //$SQL_count=  mysql_query(" SELECT COUNT(DISTINCT calllist_id) from t_call_trans where create_date like '$strNewDate%'  and agent_id = '$agent_id'   ");
    ...
    $SQL_count=  mysql_query(" SELECT COUNT(calllist_id) from t_call_trans where (create_date BETWEEN '$strNewDate 00:00:00' and '$endNewDate 23:59:59') and campaign_id = '$campaign_id' and agent_id = '$agent_id' ");
    $CallAttempt = mysql_result($SQL_count, 0);

    $SQL_count=  mysql_query(" SELECT COUNT(calllist_id) from t_call_trans where (create_date BETWEEN '$strNewDate 00:00:00' and '$endNewDate 23:59:59') and campaign_id = '$campaign_id' and agent_id = '$agent_id' and agent_id = '$agent_id' and wrapup_id = '400||' ");
    $success = mysql_result($SQL_count, 0);
