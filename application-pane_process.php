	...
	function query(){
		...
		$condition = "";
	     ...
	     if( isset($_POST['page'])){
			...
			switch( $lv ){
			   case 1 :  $condition = $condition." AND (AppStatus != 'Submit' or AppStatus != 'Submit Re-Confirm'  ) AND app.agent_id =  ".dbNumberFormat($_SESSION["uid"]); break;	
			   case 2 :  $condition = $condition." AND (AppStatus != 'Success') AND agent.team_id = ( SELECT team_id FROM t_agents WHERE agent_id = ".dbNumberFormat($_SESSION["uid"]).") "; break;
			   ...
			   case 3 : $condition = $condition." AND (AppStatus != 'Follow Doc') "; break;
			   case 7 : $condition = $condition." AND (AppStatus IN ('Approve','QC_Approved')) "; break;
