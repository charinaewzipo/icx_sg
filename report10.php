...
//						return false;
								...
								document.getElementById("frmYesfile").submit();
						}
				 }
			}
 			...
 			<li>
 				...
 				<div style="width:60%;float:left; border-bottom:1px dashed #ddd">
 						<div style="position:relative;">
								...
								<h2 style="font-family:raleway; color:#666666; margin:0; padding:0">&nbsp;Yesfile Health Lump Sum</h2>
								<div class="stack-subtitle" style="color:#777777; ">&nbsp; Yesfile Health Lump Sum</div>
								</div>
...
<form class="form-horizontal" id="frmYesfile" action="app/gen/report/YesFile_GenHealth_Export.php" name="date" method="post">
