...
<SCRIPT type=text/javascript>
	function verify() {
				...
				$.post('app/aig/report/Call_Result_Export.php', {
					"data": formtojson
				}, function (result) {
 			...
 			<li>
 				...
 				<div style="width:60%;float:left; border-bottom:1px dashed #ddd">
 						<div style="position:relative;">
								...
								<h2 style="font-family:raleway; color:#666666; margin:0; padding:0">&nbsp;Call Result Report</h2>
								<div class="stack-subtitle" style="color:#777777; ">&nbsp; Call Result</div>
								</div>
