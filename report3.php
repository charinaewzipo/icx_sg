		...
		<ul style="width:100%; list-style:none; margin:0;padding:0;">
 			...
 			<li style="padding:5px; margin-top:15px;">
 				...
 				<div style="width:35%;float:left; ">
 					 ...
 					 <!--  <input type="text" name="search_cust" style="width:250px;" autocomplete="off" placeholder="เธฃเธฐเธเธธเธเธทเนเธญเธฅเธนเธเธเนเธฒ"> -->
 				</div>
 			...
 			<li style="padding:5px; ">
 				...
 				<div style="width:35%;float:left; ">
 					 ...
 					 <input type="text" name="search_quono" style="width:250px;" autocomplete="off" placeholder="เธฃเธฐเธเธธเธซเธกเธฒเธขเน€เธฅเธ Quotation">
 				</div>
 					<div style="width:50%;float:right;">
 					<div>
 			...
 			<li style="padding:5px;">
 				...
 				<div style="width:35%;float:left;color:#666; font-size:16px;">
 					...
 					<input type="text" name="agentp_search_cred"  style="width:250px; " autocomplete="off" placeholder="เน€เธฅเธทเธญเธเธงเธฑเธเธ—เธตเนเน€เธฃเธดเนเธกเธชเธฃเนเธฒเธ app" class="text-center calendar_en"> 
 				</div>
 					<div style="width:50%;float:right;">
 					<div style="color:#666;">
 						 <span style="font-size:15px; line-height:30px;width:100px;display:inline-block;"> End Date</span> : 
 						<input type="text" name="agentp_search_endd"  style="width:250px;" autocomplete="off" placeholder="เน€เธฅเธทเธญเธเธงเธฑเธเธ—เธตเนเธชเธดเนเธเธชเธธเธ”เธเธฒเธฃเธชเธฃเนเธฒเธ app" class="text-center calendar_en"> 
 					</div>
 				</div>
 				<div style="clear:both"></div>
 			</li>
 			...
 			<li style="padding:5px;">
 				...
 				<div style="width:35%;float:left; color:#666;font-size:15px;">
 					...
 					<input type="text" name="search_paidcred"  style="width:250px; " autocomplete="off" placeholder="เน€เธฅเธทเธญเธเธงเธฑเธเธ—เธตเนเน€เธฃเธดเนเธกเน€เธเนเธเน€เธเธดเธ" class="text-center calendar_en"> 
 				</div>
 					<div style="width:50%;float:right;">
 					<div style="color:#666;">
 						 <span style="font-size:15px; line-height:30px;width:100px;display:inline-block;"> End Date</span>  : 
 						<input type="text" name="search_paidendd"  style="width:250px;" autocomplete="off" placeholder="เน€เธฅเธทเธญเธเธงเธฑเธเธ—เธตเนเธชเธดเนเธเธชเธธเธ”เธเธฒเธฃเน€เธเนเธเน€เธเธดเธ" class="text-center calendar_en"> 
 					</div>
 				</div>
 				<div style="clear:both"></div>
 			</li>
