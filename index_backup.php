    ...
    <div style="position:relative; height:100%;  " class="shadow img">
      <!-- 
	    <img src="images/logo.png" style="width:150px; height:60px;"> <span style="font-size:14px; color:#fff;position:relative; top:-25px;">by RSY Leasing </span>
	      	   -->
	      <div style="z-index:10; padding:40px 0;background-color:rgba(255,255,255,0.1);position:relative;  margin-left: 0%; text-align:center; height:70%px; top:10%; "  > 
						<div style="z-index:21; "> <!-- margin-left:50%  -->
			    			<div style="display: inline-block;">
			    					<table class="login-table"  style="min-width:400px;">
											<tr>
											  	<td class="title-h1" style="text-align:center;  height:50px; font-family:raleway"><i class="icon-fire" ></i> Tubtim <!-- <sup style="font-size:14px;  font-family:raleway; letter-spacing: 0px; padding:5px; background-color:rgba(255,205,2, 0.9); border-radius:4px; color:#fff">  </sup> --></td>
											</tr>
											<tr>
