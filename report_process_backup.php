...
<?php
   	...
   	if(isset($_POST['action'])){ 
         ...
         switch( $_POST['action']){
         	...
         	case "getcmp" : getCampaign(); break;
         	case "getlead" : getLead(); break;
         	
         	case "getgroup" : getGroup(); break;
         	case "getteam" : getTeam(); break;
         	
         	//agent performance report
         	case "agent_performance_report" : agent_performance_report(); break;
         	case "agent_performance_report_export" : agent_performance_report_export(); break;
         	
         	//list conversion report
         	case "list_conversion_report" : list_conversion_report(); break;
         	case "list_conversion_report_export" : list_conversion_report_export(); break;
         	
         	//call wrapup report
         	case "call_wrapup_report" : call_wrapup_report(); break;
         	case "call_wrapup_report_export" : call_wrapup_report_export(); break;
	...
	function agent_performance_report(){
		...
		$res = $dbconn->createConn();
	     ...
	     $sql = " SELECT group_name,team_name,first_name,last_name,transaction_dt,transfer_total_rec,revoke_total_rec,  list_onhand ".
	     			...
	     			" FROM rpt_t_agent_performance_daily".
