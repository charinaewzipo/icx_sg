 (function($){
	var url = "application-pane_process2.php";
	  jQuery.app = {
									 ...
									 for(i=0;i<size;i++){
									     ...
									     txt = txt+"<tr id='"+result.data[i].quono+"'><td class='text-center'>&nbsp;"+seq+"&nbsp;</td>"+
									    		  "<td class='text-center'>&nbsp;"+result.data[i].quono+"</td>"+
									    		   ...
									    		   " <a style='border-radius:4px; margin:0 10px; background-color:#2196f3' class='btn btn-primary  btn-sm' href='"+linkProduct+"?Id="+result.data[i].quono+"' target='_blank'>Open App</a>" +
									    		   " <a  style='border-radius:4px;' class='btn btn-danger  btn-sm'  href='"+linkGenForm +"?Id="+result.data[i].quono+"' target='_blank'>Gen App</a>"+
									    		   "</td></tr>";
									   ...
									   if(result.data[i].camp == 'GenExclusive' ) {
									     ...
									     txt = txt+"<tr id='"+result.data[i].quono+"'><td class='text-center'>&nbsp;"+seq+"&nbsp;</td>"+
									    		  "<td class='text-center'>&nbsp;"+result.data[i].quono+"</td>"+
									    		   ...
									    		   "<td class='text-center' >" +
									    		   " <a style='border-radius:4px; margin:0 10px; background-color:#2196f3' class='btn btn-primary  btn-sm' href='"+linkProduct+"?Id="+result.data[i].quono+"' target='_blank'>Open App</a>" +
									    		   " <a  style='border-radius:4px;' class='btn btn-danger  btn-sm'  href='"+linkProduct+"?Id="+result.data[i].quono+"' target='_blank'>Gen App</a>"+
									    		   "</td></tr>";
									   }
									$table.html(txt);
									page = parseInt(page) + 1;
