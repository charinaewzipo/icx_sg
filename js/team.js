					...
					'success' : function(data){ 
									...
									var i=0;
											 ...
											 for( i=0 ; i<result.length ; i++){
											     ...
											     $row = $("<tr id='"+result[i].tid+"'><td style='vertical-align:middle; text-align:right' >&nbsp;"+seq+"&nbsp;</td>"+
											    		   "<td ><a href='#' class='nav-team-id'><strong>&nbsp;"+result[i].tname+"</strong></a><br/><span style='color:#777777;'>&nbsp;"+result[i].tdetail+"</span></td>"+		
