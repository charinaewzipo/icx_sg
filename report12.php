...
//						return false;
							...
							$.post( "app/gen/report/DCR_GenExclusive_Export2.php",$( "#frmYesfile" ).serialize(), function(data) {
								if(data)
								{
 			...
 			<li>
 				...
 				<div style="width:60%;float:left; border-bottom:1px dashed #ddd">
 						<div style="position:relative;">
								...
								<h2 style="font-family:raleway; color:#666666; margin:0; padding:0">&nbsp;DCR GenExclusive (เงินสด)</h2>
