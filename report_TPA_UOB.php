...
<SCRIPT type=text/javascript>
	function verify() {
				...
				$.post('app/aig/report/TPA_UOB_Export.php', {
					"data": formtojson
				}, function (result) {
					var response = eval('(' + result + ')');
					if (response.result == "success") {
						window.location = "app/aig/report/dw.php?p=temp/TPA_File_UOB_"+$('[name=campaign_id]').val()+".txt&o=y";
					}
				});
			}
  </SCRIPT>
 			...
 			<li>
 				...
 				<div style="width:60%;float:left; border-bottom:1px dashed #ddd">
 						<div style="position:relative;">
								...
								<h2 style="font-family:raleway; color:#666666; margin:0; padding:0">&nbsp;TPA UOB Export</h2>
								<div class="stack-subtitle" style="color:#777777; ">&nbsp; TPA UOB Export</div>
								</div>
