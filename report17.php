...
//						return false;
							...
							$.post( "app/gen/report/daily_detail_export.php",$( "#my_form" ).serialize(), function(data) {
								if(data)
								{
 			...
 			<li>
 				...
 				<div style="width:60%;float:left; border-bottom:1px dashed #ddd">
 						<div style="position:relative;">
								...
								<h2 style="font-family:raleway; color:#666666; margin:0; padding:0">&nbsp;Daily Detail Report (Ganerali)</h2>
								<div class="stack-subtitle" style="color:#777777; ">&nbsp; Daily Detail Report (Ganerali)</div>
								</div>
