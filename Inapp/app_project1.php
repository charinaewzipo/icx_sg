...
<link rel="shortcut icon" type="image/x-icon" href="fonts/fav.ico">
  ...
  <h2> Application of campaign 1 </h2>
  ...
  <br/>
	...
	create user <input type="text" name="uid" value="10">
		<table class=""> 
			<thead>
				<tr>
					<td style="border-bottom:1px solid #000;" colspan="4">Sales Application </td>
				</tr>
			</thead>
			<tbody>
				<tr>
				...
				<tr>
					...
					<td>
							<input type="radio" name="product" value="p1"> Plan1 Starter : 10$  <br/>
							<input type="radio" name="product" value="p2"> Plan2 Small : 20$ <br/>
							<input type="radio" name="product" value="p3">  Plan3 Business : 50$ <br/>
							<input type="radio" name="product" value="p4"> Plan4 Enterprise : 99$<br/>
					</td>
				</tr>
			</tbody>
			<tfoot>
