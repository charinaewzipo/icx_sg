...
{ 
	...
	$SQL_count =  mysql_query("  select sum(INSTALMENT_PREMIUM) FROM t_app where (Sale_Date BETWEEN '$startdate1' and '$enddate1') and campaign_id = '1' and  agent_id = '$agent_id' and PaymentFrequency = 'รายเดือน' ");
	$list_submit_afyp_m = mysql_result($SQL_count, 0);
	
	$SQL_count =  mysql_query("  select sum(INSTALMENT_PREMIUM) FROM t_app where (Sale_Date BETWEEN '$startdate1' and '$enddate1') and campaign_id = '1' and  agent_id = '$agent_id' and PaymentFrequency = 'รายปี' ");
	$list_submit_afyp_y = mysql_result($SQL_count, 0);
	
	$list_submit_afyp = ($list_submit_afyp_m*6)+$list_submit_afyp_y ;
	
	$SQL_count =  mysql_query("  select count(INSTALMENT_PREMIUM) FROM t_app where (Sale_Date BETWEEN '$startdate1' and '$enddate1') and campaign_id = '1' and  agent_id = '$agent_id' ");
	$list_submit_no= mysql_result($SQL_count, 0);
	
	$SQL_count =  mysql_query("  select sum(INSTALMENT_PREMIUM) FROM t_app where (Approved_Date BETWEEN '$startdate1' and '$enddate1') and campaign_id = '1' and  agent_id = '$agent_id' and PaymentFrequency = 'รายเดือน' and AppStatus = 'Success' ");
	$list_approved_afyp_m = mysql_result($SQL_count, 0);
	
	$SQL_count =  mysql_query("  select sum(INSTALMENT_PREMIUM) FROM t_app where (Approved_Date BETWEEN '$startdate1' and '$enddate1') and campaign_id = '1' and  agent_id = '$agent_id' and PaymentFrequency = 'รายปี' and AppStatus = 'Success' ");
	$list_approved_afyp_y = mysql_result($SQL_count, 0);
	
	$list_approved_afyp = ($list_approved_afyp_m*6)+$list_approved_afyp_y;
	
	$SQL_count =  mysql_query("  select count(INSTALMENT_PREMIUM) FROM t_app where (Approved_Date BETWEEN '$startdate1' and '$enddate1') and campaign_id = '1' and  agent_id = '$agent_id' ");
...
?>                                    
                                        	...
                                        	<tr>
                                                ...
                                                <td><?php echo  $list_used_total;?></td>
