<!--  KPI Report (TK1) call to Yok application -->
 			...
 			<li>
 				...
 				<div style="width:60%;float:left; border-bottom:1px dashed #ddd">
 						<div style="position:relative;">
								...
								<h2 style="font-family:raleway; color:#666666; margin:0; padding:0">&nbsp;KPI Report </h2>
								<div class="stack-subtitle" style="color:#777777; ">&nbsp;  KPI Report</div>
								</div>
...
<script>
 $(function(){
	 ...
	 $('.report-back-main').click( function(e){
			$('#report6-pane').fadeOut( 'fast' , function(){
		...
		$('.search-agentpermance-btn').click( function(e){
				...
				window.open('http://10.10.10.252:8080/crm_gen/GEN/report//KPI_Report.php'+param);
