							 ...
							 if($rs=mysql_fetch_array($result)){
								   ...
								   $sql = " UPDATE t_calllist_agent SET ".
									...
									$dbconn->executeUpdate($sql); 
										...
										$sql = " INSERT INTO t_call_trans ( number_of_call , campaign_id , import_id , calllist_id , agent_id , uniqueid , wrapup_option_id , wrapup_id , wrapup_note , create_date ) VALUES ( (SELECT ".
	...
	function query_newlist(){
	    ...
	    //prepare call popup  action 
	     $sql = " SELECT campaign_name , campaign_detail , external_web_url , script_detail ".
			...
			$sql = $sql." order by assign_dt desc ";
