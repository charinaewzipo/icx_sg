<SCRIPT type=text/javascript>
	function verify() {
		...
		$.post('app/aig/report/Agent_Performance_Export_ByLead.php', {
			"data": formtojson
		}, function(result) {
			...
			<div style="width:60%;float:left; border-bottom:1px dashed #ddd">
				<div style="position:relative;">
					...
					<div style="display:inline-block; float:left; margin-left:5px;">
						<h2 style="font-family:raleway; color:#666666; margin:0; padding:0">&nbsp;Agent Performance Report By Lead</h2>
						<div class="stack-subtitle" style="color:#777777; ">&nbsp; Agent Performance Report By Lead</div>
					</div>
